...
public interface ConsumerRepository
    ...
    @Query(value="select count(distinct(concat(c.identification_type,c.identification_number))) sum from consumers c where c.service_provider_id in :ids and c.created_on between :createdOnStart and :createdOnEnd and is_consistent = :isConsistent",nativeQuery = true)
